	          ...
	          <div class="">
	            <div class="page-title">
	              <div class="title_left">
	                 <h3><b id=""><?php echo $this->lang->line('users_activations_cods') ?></b></h3>  
	              </div>
	          ...
	          <div class="clearfix"></div>
	            ...
	            <div class="row">
	              <div class="col-md-12 col-sm-12 col-xs-12">
	                <div class="x_panel">
	                  <div class="x_content">
	                    <table id="users_codes_table" class="table table-striped table-bordered">
	                      <thead>
	                        <tr>
	                          <th>#</th>
	                          ...
	                          <th><?php echo $this->lang->line('code_status') ?></th>
	                        </tr>
	                      </thead>
	                      <tbody>
	                     </tbody>

    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content" style="width:350px; !important">
        ...
        <div class="modal-footer">
          <button onclick="save_certificate()" class="btn btn-success data_update_btn"><?php echo $this->lang->line('save') ?></button>
          <button onclick="delete_certificate()" id="certificate_delete_btn"  type="button" class="btn btn-danger data_delete_btn"><?php echo $this->lang->line('delete') ?></button>
        </div>
      </div>
    </div>
  </div>

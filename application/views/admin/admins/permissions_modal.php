        ...
        <div class="modal-body">
           <form id="permissions_form" acrion="post"  class="form-horizontal form-label-left">
	         ...
	         <div class="form-group row">
                ...
                <div class="checkbox col-md-6">
	                <label>
	                  <input class='permission_check flat' value="<?php echo PERMISSION::EXPORT_REPORTS; ?>" id="<?php echo PERMISSION::EXPORT_REPORTS; ?>" type="checkbox"  name="permissions[]">  <?php echo $this->lang->line('export_reports') ?>
	                </label>
                </div>
	         </div>
	         ...
	         <div class="form-group row">
        	    <div class="checkbox col-md-6">
	                <label>
	                  <input class='permission_check flat' value="<?php echo PERMISSION::COMMERCIALS_MANAGE; ?>" id="<?php echo PERMISSION::COMMERCIALS_MANAGE; ?>" type="checkbox"  name="permissions[]">  <?php echo $this->lang->line('commercials_manage');?>
	                </label>
                </div>
                <div class="checkbox col-md-6">
	                <label>
	                  <input class='permission_check flat' value="<?php echo PERMISSION::EXPORT_COMMERCIALS; ?>" id="<?php echo PERMISSION::EXPORT_COMMERCIALS; ?>" type="checkbox"  name="permissions[]">  <?php echo $this->lang->line('export_commercials') ?>
	                </label>
                </div>
	         </div>
	         ...
	         <div class="form-group row">
                ...
                <div class="checkbox col-md-6">
	                <label>
	                  <input class='permission_check flat' value="<?php echo PERMISSION::EXPORT_DATA; ?>" id="<?php echo PERMISSION::EXPORT_DATA; ?>" type="checkbox"  name="permissions[]">  <?php echo $this->lang->line('export_data') ?>
	                </label>
                </div>
	         </div>
	         ...
	         <div class="form-group row">
                ...
                <div class="checkbox col-md-6">
	                <label>
	                  <input class='permission_check flat' value="<?php echo PERMISSION::EXPORT_NOTIFICATIONS; ?>" id="<?php echo PERMISSION::EXPORT_NOTIFICATIONS; ?>" type="checkbox"  name="permissions[]">  <?php echo $this->lang->line('export_notification') ?>
	                </label>
                </div>
	         </div>

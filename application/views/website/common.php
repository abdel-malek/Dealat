...
<script id="main-commercial-ads-template" type="text/template">
	{{#.}}
	<div class="slide">
		<a target="_blank" {{#ad_url}} href="{{ad_url}}" {{/ad_url}} data-commercial_ad_id="{{commercial_ad_id}}" >
...
<script id="side-commercial-ads-template" type="text/template">
	{{#.}}
	<div class="banner">
		<a target="_blank" {{#ad_url}} href="{{ad_url}}" {{/ad_url}} data-commercial_ad_id="{{commercial_ad_id}}"><img src="<?php echo base_url("{{image}}"); ?>" class="img-fluid" alt="{{title}}" title="{{title}}"></a>
	</div>
	{{/.}}
</script>

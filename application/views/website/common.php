		...
		<div class="modal-content">
          ...
          <span aria-hidden="true">&times;</span>
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn button2 report">report ad</button>
			</div>
		</div>
	</div>
</div>
		...
		<div class="card-body">
			...
			<div class="row">
				...
				<div class="col-4 info-col">
					<div class="number"><span class="number-lbl">Ad number: </span><span class="number-val">{{ad.ad_id}}</span></div>
				...
				<div class="col-4 info-col templates">
					...
					<div class="template-vehicles template d-none" data-template-id="1">
						<div class="type field type_name"><span class="type-lbl">Type:</span><span class="type-val"> {{ad.type_name}}</span></div>
						<div class="model field type_model_name"><span class="model-lbl">Model:</span><span class="model-val"> {{ad.type_model_name}}</span></div>
						<div class="manufacture_date field"><span class="manufacture_date-lbl">Manufacture date:</span><span class="manufacture_date-val"> {{ad.manufacture_date}}</span></div>
						<div class="is_automatic field"><span class="is_automatic-lbl">Automatic:</span><span class="is_automatic-val"> {{automatic}}</span></div>
						<div class="is_new field"><span class="is_new-lbl"></span>Status:<span class="is_new-val"> {{status}}</span></div>
						<div class="kilometer field"><span class="kilometer-lbl">Kilometer:</span><span class="kilometer-val"> {{ad.kilometer}}</span></div>
					</div>

					<!--properties template-->
					<div class="template-properties template d-none" data-template-id="2">
						<div class="space field"><span class="space-lbl">Space:</span><span class="space-val"> {{ad.space}}</span></div>
						<div class="rooms_num field"><span class="rooms_num-lbl">Rooms:</span><span class="rooms_num-val"> {{ad.rooms_num}}</span></div>
						<div class="floor field"><span class="floor-lbl">Floor:</span><span class="floor-val"> {{ad.floor}}</span></div>
						<div class="state field"><span class="state-lbl">State:</span><span class="state-val"> {{ad.state}}</span></div>
						<div class="with_furniture field"><span class="with_furniture-lbl">Furniture:</span><span class="with_furniture-val"> {{furniture}}</span></div>
					</div>
					...
					<div class="template-mobiles template d-none" data-template-id="3">
						<div class="type field type_name"><span class="type-lbl">Type:</span><span class="type-val"> {{ad.type_name}}</span></div>
						<div class="model field type_model_name"><span class="model-lbl">Model:</span><span class="model-val"> {{ad.type_model_name}}</span></div>
						<div class="is_new field"><span class="is_new-lbl">Status:</span><span class="is_new-val"> {{status}}</span></div>
					</div>
					...
					<div class="template-electronics template d-none" data-template-id="4">
						<div class="type field type_name"><span class="type-lbl">Type:</span><span class="type-val"> {{ad.type_name}}</span></div>
						<div class="model field type_model_name"><span class="model-lbl">Model:</span><span class="model-val"> {{ad.type_model_name}}</span></div>
						<div class="size field"><span class="size-lbl">Size:</span><span class="size-val"> {{ad.size}}</span></div>
						<div class="is_new field"><span class="is_new-lbl">Status:</span><span class="is_new-val"> {{status}}</span></div>
					</div>
					...
					<div class="template-job template d-none" data-template-id="8">
						<div class="schedule field schedule_name"><span class="schedule-lbl">Schedule:</span><span class="schedule-val"> {{ad.schedule}}</span></div>
						<div class="education field education_name"><span class="education-lbl">Education:</span><span class="education-val"> {{ad.education}}</span></div>
						<div class="experience field experience"><span class="experience-lbl">Experience:</span><span class="experience-val"> {{ad.experience}}</span></div>
						<div class="salary field"><span class="salary-lbl">Salary:</span><span class="salary-val"> {{ad.salary}}</span></div>
					</div>
				...
				<form id="filter-form">
					...
					<div class="row">
						<div class="col-sm-6">
							...
							<input type="hidden" name="furniture_name">
							<input type="hidden" name="education_name">
							<input type="hidden" name="schedule_name">
							<input type="hidden" name="automatic_name">
							<input type="hidden" name="years_name">
						...
						<div class="col-sm-6">
							...
							<div class="template-electronics template d-none" data-template-id="4">
								...
								<div class="form-group field size">
									...
									<div class="row">
										<div class="col-sm-6">
											<input type="number" class="form-control" name="size_min" placeholder="min" min="0">
										</div>
										<div class="col-sm-6">
											<input type="number" class="form-control" name="size_max" placeholder="max" min="0">
										</div>
									</div>
								</div>
	...
	<div class="modal-dialog modal-dialog-centered modal-sm" role="document">
		<div class="modal-content">
          ...
          <span aria-hidden="true">&times;</span>
			...
			<div class="modal-footer">
				<button type="submit" class="btn button2 submit" form="report-form">report</button>
			</div>
		</div>
	</div>
</div>

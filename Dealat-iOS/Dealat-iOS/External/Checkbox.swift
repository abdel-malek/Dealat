...
public class Checkbox: UIControl {
    ...
    ///
    /// **Default:** `2`
    public var borderWidth2: CGFloat = 2
...
class CheckBox2: UIButton {
    // Images
    let checkedImage = #imageLiteral(resourceName: "icons8-checked-checkbox") // #imageLiteral(resourceName: "icons8-checked")
    let uncheckedImage = #imageLiteral(resourceName: "icons8-checked-uncheckbox")  // #imageLiteral(resourceName: "icons8-unchecked")
